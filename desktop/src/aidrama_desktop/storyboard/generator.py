...
class StoryboardGenerationConfig:
    ...
    target_shots: int = DEFAULT_TARGET_SHOTS
    ...
    def from_payload(cls, payload: dict[str, Any] | None) -> "StoryboardGenerationConfig":
        ...
        return cls(
            ...
            target_shots=positive_int(data.get("targetShots")) or DEFAULT_TARGET_SHOTS,
...
class StoryboardGenerator:
    ...
    def _build_storyboard(
        ...
        *,
        ...
        total = max(int(config.target_shots or DEFAULT_TARGET_SHOTS), 1)
        ...
        return {
            ...
            "workspace": {
                ...
                "style": config.style or DEFAULT_STYLE,
...
def build_deepseek_request(storyboard: dict[str, Any], model: str) -> dict[str, Any]:
    ...
    user_payload = {
        ...
        "constraints": [
            ...
            "没有字幕和视觉识别时，不要编造具体对白。",
            "title 控制 4-8 个中文字符，summary 控制 30-60 个中文字符。",
